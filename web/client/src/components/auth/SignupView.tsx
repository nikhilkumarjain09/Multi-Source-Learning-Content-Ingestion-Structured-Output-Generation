      ...
      <div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '0.55rem' }}>
          ...
          <div style={{ marginTop: '0.1rem' }}>
            <label style={{ display: 'flex', alignItems: 'center', gap: '0.35rem', fontSize: '11px', color: 'var(--text-secondary)', cursor: 'pointer' }}>
              <input
                type="checkbox"
                checked={acceptTerms}
                onChange={(e) => {
              ...
              />
              <span>
                Agree to <a href="#terms" onClick={(e) => e.preventDefault()} style={{ color: 'var(--accent)', fontWeight: 600 }}>Terms</a> & <a href="#privacy" onClick={(e) => e.preventDefault()} style={{ color: 'var(--accent)', fontWeight: 600 }}>Privacy</a>
              </span>
            </label>
          ...
          <button
            ...
            disabled={loading}
            style={{ width: '100%', justifyContent: 'center', padding: '0.55rem', fontSize: '12px', fontWeight: 600, marginTop: '0.15rem' }}
          >
            {loading ? <RefreshCw size={15} className="spinner" /> : <span>Create Account</span>}
            {!loading && <ArrowRight size={14} />}
          </button>
        </form>

        {/* Switch to Login Prompt */}
        <div style={{ marginTop: '0.65rem', textAlign: 'center', fontSize: '12px', color: 'var(--text-secondary)' }}>
